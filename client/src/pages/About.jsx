        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-8 border-t border-surface pt-10">
              <div>
                <h4 className="text-3xl font-serif text-main">50K+</h4>
              ...
              <div>
                <h4 className="text-3xl font-serif text-main">5.0</h4>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {values.map((value, idx) => (
              ...
              >
                <div className="w-16 h-16 bg-surface rounded-full flex items-center justify-center mx-auto mb-8 shadow-md group-hover:bg-primary group-hover:text-white transition-all duration-500">
                  <value.icon size={28} />
                </div>
            ...
            <div className="grid lg:grid-cols-4 gap-8 relative z-10">
              {timeline.map((item, idx) => (
                <m.div
                  ...
                  className="bg-surface p-10 shadow-lg group hover:-translate-y-4 transition-all duration-500 border-t-4 border-primary/20 hover:border-primary"
                >
                  ...
                  <h3 className="text-sm uppercase tracking-[0.2em] font-bold mb-6 text-main group-hover:text-primary transition-colors">
                    {item.title}
                  </h3>
