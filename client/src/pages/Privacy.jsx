    ...
    <div className="pt-40 pb-32 bg-secondary min-h-screen selection:bg-primary selection:text-white">
      <div className="container max-w-4xl px-6 md:px-8">
        ...
        >
          ...
          <h1 className="text-4xl md:text-7xl font-serif leading-tight text-main italic">Privacy <span className="not-italic font-sans text-primary">Policy</span></h1>
        ...
        <m.div 
          ...
          className="bg-surface p-8 md:p-20 shadow-2xl border border-surface rounded-sm prose prose-zinc prose-invert max-w-none"
        >
          <div className="space-y-16">
            ...
            <section className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-6 bg-secondary/50 border border-surface rounded-sm">
